...
-----------------------------------------------------------------------
	...
	--ARTIST 1
	makeLuaText('ARTIST1', 'anarackWarriors', 1000, 132, -1000)
	...
	--ARTIST 2
	makeLuaText('ARTIST2', 'Noveni', 1000, 132, -1000)
	...
	--ARTIST 3
	makeLuaText('ARTIST3', '', 1000, 132, -1000)
	...
	--MUSICIAN 1
	makeLuaText('MUSICIAN1', 'BananaTheMusician', 1000, 132, -1000)
	...
	--MUSICIAN 2
	makeLuaText('MUSICIAN2', 'MayC', 1000, 132, -1000)
