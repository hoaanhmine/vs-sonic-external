...
-----------------------------------------------------------------------
	...
	makeLuaText('CODER2', '', 1000, 132, -1000)
	...
	--ARTIST 1
	makeLuaText('ARTIST1', 'Batif', 1000, 132, -1000)
	...
	--ARTIST 2
	makeLuaText('ARTIST2', 'A Maze', 1000, 132, -1000)
	...
	--ARTIST 3
	makeLuaText('ARTIST3', 'Elemenope', 1000, 132, -1000)
	...
	--MUSICIAN 1
	makeLuaText('MUSICIAN1', 'Sturm (AKA Churgney Gurgney)', 1000, 132, -1000)
