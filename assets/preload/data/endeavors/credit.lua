...
-----------------------------------------------------------------------
	...
	makeLuaText('CODER2', 'Retr0', 1000, 132, -1000)
	...
	--ARTIST 1
	makeLuaText('ARTIST1', 'Rechi Phill', 1000, 132, -1000)
	...
	--ARTIST 2
	makeLuaText('ARTIST2', 'Raena Torresmo', 1000, 132, -1000)
	...
	--ARTIST 3
	makeLuaText('ARTIST3', 'Retr0', 1000, 132, -1000)
	...
	--MUSICIAN 1
	makeLuaText('MUSICIAN1', 'Danly', 1000, 132, -1000)
	...
	--MUSICIAN 2
	makeLuaText('MUSICIAN2', 'Ghostlab', 1000, 132, -1000)
	...
	--MUSICIAN 3
	makeLuaText('MUSICIAN3', 'Sturm', 1000, 132, -1000)
