...
-----------------------------------------------------------------------
	...
	--------CODING CREW--------
	--CODER 1
	makeLuaText('CODER1', 'FleetDev', 1000, 132, -1000)
	setTextAlignment('CODER1', 'center')
	setTextSize('CODER1', 25)
	setObjectCamera('CODER1', 'other')
	addLuaText('CODER1')
	
	makeLuaText('CODER2', 'Ivylinus.møno', 1000, 132, -1000)
	...
	--ARTIST 1
	makeLuaText('ARTIST1', 'Ivylinus.møno & Estaguy ', 1000, 132, -1000)
	...
	--ARTIST 2
	makeLuaText('ARTIST2', 'Anarack Warriors', 1000, 132, -1000)
	...
	--ARTIST 3
	makeLuaText('ARTIST3', 'Noveni', 1000, 132, -1000)
	...
	--MUSICIAN 1
	makeLuaText('MUSICIAN1', 'armydillo', 1000, 132, -1000)
	...
	--MUSICIAN 2
	makeLuaText('MUSICIAN2', '', 1000, 132, -1000)
	...
	--MUSICIAN 3
	makeLuaText('MUSICIAN3', '', 1000, 132, -1000)
