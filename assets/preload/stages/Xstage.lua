	...
	function onCreate()
	makeLuaSprite('skyX', 'exe/Xstage/skyX', -820, -300);
	scaleObject('skyX', 0.5, 0.4);	
	makeLuaSprite('tree', 'Xstage/tree', 1150, -370);
	scaleObject('tree', 0.7, 0.7);
	
       makeLuaSprite('smflower', 'exe/Xstage/smflower', 980, 460);
	scaleObject('smflower', 0.6, 0.6);

makeLuaSprite('smflower2', 'exe/Xstage/smflower2', -200, 460);
	scaleObject('smflower2', 0.6, 0.6);


    makeLuaSprite('Hills2', 'exe/Xstage/Hills2', -800, 420);
	scaleObject('Hills2', 0.5, 0.4);

	makeLuaSprite('Hills1', 'exe/Xstage/Hills1', -800, -200);
	scaleObject('Hills1', 0.6, 0.5);

	makeLuaSprite('groundX', 'exe/Xstage/groundX', -740, 600);
	scaleObject('groundX', 0.6, 0.5);
    makeAnimatedLuaSprite('fanim', 'exe/Xstage/Weird', -400, 100);
